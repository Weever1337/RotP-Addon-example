...
public class AddonPackets {
    ...
    public static void init() {
        ...
        registerMessage(channel, new TutorialDataPacket.Handler(), Optional.of(NetworkDirection.PLAY_TO_CLIENT));
    }
    ...
    public static void sendToClient(Object msg, PlayerEntity player) {
        if (player instanceof ServerPlayerEntity) {
            ...
            AddonMain.LOGGER.warn("You can't send a message not by a player: " + player.getName());
        }
    }
